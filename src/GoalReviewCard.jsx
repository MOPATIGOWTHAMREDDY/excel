...
function GoalReviewCard({ goal, isHighlighted }) {
  ...
  const agreementPercentage = goal.parameters.length > 0 
        ...
        <div className="p-4">
          {showHelp && (
            <div className="mb-4 p-3 bg-blue-50 text-blue-700 rounded text-sm">
              <strong>Tip:</strong> Review disagreements carefully and update the status when resolved.
            </div>
          )}
